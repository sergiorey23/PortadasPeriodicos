...
class Periodicos {
    ...
    static final String [] locales = {"vozgalicia:lavozdegalicia.es", "diario_sevilla:diariodesevilla.es", "diario_informacion:informacion.es",
            ...
            "nortecastilla_valladolid:elnortedecastilla.es","larioja:larioja.com", "diario_leon:diariodeleon.es", "diario_avila:diariodeavila.es",
            "lasprovincias:lasprovincias.es", "farovigo:farodevigo.es", "laprovincia:laprovincia.es", "hoy_badajoz:hoy.es/extremadura",
